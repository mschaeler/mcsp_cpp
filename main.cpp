...
int main(int argc, char* argv[]) {
    ...
    vector<DatabaseSystem*> all_dbms = {new Elf_Dbms_Lvl(), new Elf_Dbms_Lvl_Ranges_External(), new MyMonetDB_Indexed(), new SortedProjectionDBMS(), new MyMonetDB(), new MyHyper(), new MyRowiseHyper()};
