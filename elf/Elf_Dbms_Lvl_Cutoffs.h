...
#ifndef MY_MCSP_ELF_DBMS_LVL_CUTOFFS_H
#define MY_MCSP_ELF_DBMS_LVL_CUTOFFS_H

#include "Elf_Dbms_Lvl.h"

class Elf_Dbms_Lvl_Cutoffs : public Elf_Dbms_Lvl{
public:
    ...
    std::unique_ptr<Table> get_TPC_H_lineitem(double scale){
        ...
        auto table = std::unique_ptr<Elf_Table_Lvl_Cutoffs>(
                Elf_builder_separate::build_with_cuttoffs(col_t));
...
#endif //MY_MCSP_ELF_DBMS_LVL_CUTOFFS_H
